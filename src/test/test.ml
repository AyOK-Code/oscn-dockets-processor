...
let basic ~last_name ?first_name ?middle_name filename query () =
  let%lwt raw_case =
    Lwt_io.chars_of_file (sprintf "../../../../fixtures/%s.html" filename) |> Lwt_stream.to_string
  in
  let%lwt raw_expected =
    Lwt_io.chars_of_file (sprintf "../../../../fixtures/%s.json" filename) |> Lwt_stream.to_string
  in
...
let () =
  Lwt_main.run
  @@ Alcotest_lwt.run "Case processing"
       [
         ( "Case fixtures",
           [
             ( "case1.html",
               `Quick,
               basic ~last_name:"johnson" "case1" "?db=wagoner&number=CF-2015-00470&cmid=11288" );
             ( "case2.html",
               `Quick,
               basic ~last_name:"johnson" "case2" "?db=mcclain&number=TR-2005-01955&cmid=127475" );
             ( "case3.html",
               `Quick,
               basic ~last_name:"johnson" "case3" "?db=mcclain&number=CJ-2014-00181&cmid=16110" );
             ( "case4.html",
               `Quick,
               basic ~last_name:"ward" "case4" "?db=oklahoma&number=TR-2014-1119&cmid=3080009" );
             ( "case5.html",
               `Quick,
               basic ~last_name:"ward" "case5" "?db=oklahoma&number=CF-2015-2603&cmid=3251429" );
             ( "case6.html",
               `Quick,
               basic ~last_name:"Laughlin" "case6" "?db=oklahoma&number=CM-2010-1584&cmid=2596069" );
             ( "case7.html",
               `Quick,
               basic ~last_name:"Laughlin" "case7" "?db=oklahoma&number=CF-2016-5438&cmid=3420850" );
             ( "case8.html",
               `Quick,
               basic ~last_name:"johnson" "case8" "?db=oklahoma&number=TR-1991-3731&cmid=180879" );
             ( "case9.html",
               `Quick,
               basic ~last_name:"Vanderburg" ~first_name:"Keely" "case9"
                 "?db=oklahoma&number=CM-2020-1446&cmid=3879230" );
             ( "case10.html",
               `Quick,
               basic ~last_name:"Wilson" ~first_name:"Aaron" "case10"
                 "?db=pittsburg&number=CM-2016-00117&cmid=51212" );
             ( "case11.html",
               `Quick,
               basic ~last_name:"Miles" "case11" "?db=oklahoma&number=CF-1995-723&cmid=50663" );
             ( "case12.html",
               `Quick,
